...
static const int KW_CHAR;
static const int KW_INT;
static const int KW_FLOAT;
static const int KW_BOOL;
static const int KW_IF;
static const int KW_ELSE;
static const int KW_WHILE;
static const int KW_READ;
static const int KW_PRINT;
static const int KW_RETURN;
static const int OPERATOR_LE;
static const int OPERATOR_GE;
static const int OPERATOR_EQ;
static const int OPERATOR_DIF;
static const int TK_IDENTIFIER;
static const int LIT_INT;
static const int LIT_CHAR;
static const int LIT_REAL;
static const int LIT_FALSE;
static const int LIT_TRUE;
static const int LIT_STRING;
static const int TOKEN_ERROR;
